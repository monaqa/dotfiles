...
util.autocmd_vimrc{"ColorScheme"}{
    ...
    callback = function ()
        ...
        -- barbar
        sethl{name ="BufferCurrent",        guifg="#ebdbb2", guibg="#444444", gui="bold"}
        sethl{name ="BufferCurrentMod",     guifg="#dc9656", guibg="#444444", gui="bold"}
        sethl{name ="BufferCurrentSign",    guifg="#e9593d", guibg="#444444", gui="bold"}
        sethl{name ="BufferCurrentTarget",  guifg="red",     guibg="#444444", gui="bold"}
        sethl{name ="BufferInactive",       guifg="#bbbbbb", guibg="#777777"}
        sethl{name ="BufferInactiveMod",    guifg="#dc9656", guibg="#777777"}
        sethl{name ="BufferInactiveSign",   guifg="#444444", guibg="#777777"}
        sethl{name ="BufferInactiveTarget", guifg="red",     guibg="#777777"}
        sethl{name ="BufferVisible",        guifg="#888888", guibg="#444444"}
        sethl{name ="BufferVisibleMod",     guifg="#dc9656", guibg="#444444"}
        sethl{name ="BufferVisibleSign",    guifg="#888888", guibg="#444444"}
        sethl{name ="BufferVisibleTarget",  guifg="red",     guibg="#444444"}
        sethl{name ="BufferTabpages",       guifg="#e9593d", guibg="#444444", gui="bold"}
        sethl{name ="BufferTabpageFill",    guifg="#888888", guibg="#c8c8c8"}
        sethl{name ="TabLineFill",          guibg="#c8c8c8"}
